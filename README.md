...
Bicep modules are parametric, s  - you can choose any network plugin:
...
- [BY  - CNI](https://learn.microsoft.com/en-us/azure/aks/use-byo-cni?tabs=azure-cli)
